      ...
      <div className="mx-auto max-w-7xl px-5">
        ...
        >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <a href="/#pricing" className="group flex items-center gap-1.5 sm:gap-2 rounded-xl bg-blue shadow-glow px-3 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-[14px] font-semibold text-white transition-all duration-300 hover:bg-blue-600 active:scale-95 whitespace-nowrap">
              <span>Start — $2.9/wk</span>
