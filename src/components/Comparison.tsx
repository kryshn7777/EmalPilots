    ...
    <section className="relative bg-slate-wash py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-5">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="mt-4 text-[17px] leading-relaxed text-slate-ink">Everyone else charges you a monthly fortune to send cold email. You're already paying for Gmail or Outlook — Email Pilots just makes it send for you, for the price of a weekly coffee.</motion.p>
        </motion.div>
