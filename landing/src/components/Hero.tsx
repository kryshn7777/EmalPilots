...
export function Hero() {
  ...
  useGSAP(
    () => {
      ...
      // Scroll parallax: copy drifts up + fades as you leave the hero.
      gsap.to('.hero-copy', {
        yPercent: -18,
        autoAlpha: 0.35,
        ease: 'none',
  ...
  return (
    <section ref={root} id="top" className="relative min-h-screen overflow-hidden text-paper">
      {/* Left fog so the headline stays legible over the drifting sky. */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{ background: 'linear-gradient(105deg, rgba(8,16,40,0.92) 0%, rgba(8,16,40,0.66) 42%, rgba(8,16,40,0) 74%)' }}
      />
      ...
      <div className="hero-copy relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-5 pt-16">
        <div className="max-w-2xl">
          ...
          <div className="hero-rise mt-9 flex flex-wrap items-center gap-4">
            ...
            <Button href="#features" variant="ghost">See it fly</Button>
          </div>
